...
__DEFINE__(1667656059343, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1667656059344,"./event-store":1667656059345}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1667656059344, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1667656059345, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1667656059344,"./utils":1667656059346}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1667656059346, function(require, module, exports) {
...
return __REQUIRE__(1667656059343);
})()
